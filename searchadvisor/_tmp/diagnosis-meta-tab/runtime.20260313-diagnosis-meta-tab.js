...
\`;
  ...
  function buildSnapshotShellBootstrapScript() {
    return [
      ...
      "    const matched = snapshotState.allSites.find(function (site) {",
      ...
      '    snapshotState.curMode = activeMode && activeMode.getAttribute("data-m") === "site" ? "site" : "all";',
      '    const activeTab = document.querySelector("#sadv-tabs .sadv-t.on");',
      '    snapshotState.curTab = activeTab ? activeTab.getAttribute("data-t") || "overview" : "overview";',
      ...
      "  }",
      "  const api = {",
      "    getState: function () { return cloneState(); },",
      ...
      '      else { const button = document.querySelector("#sadv-mode-bar [data-m=\\"" + mode + "\\"]"); if (button) button.click(); }',
      "      scheduleSync();",
      "    },",
      ...
      '      else { const button = document.querySelector("#sadv-tabs [data-t=\\"" + tab + "\\"]"); if (button) button.click(); }',
      "      scheduleSync();",
      "    },",
      "    refresh: function () {",
      '      alert("저장한 HTML은 정적 스냅샷입니다. 원본 화면에서 전체 재수집 후 다시 저장해주세요.");',
      "    },",
      "    download: function () {",
      '      alert("저장한 HTML 안에서는 다시 저장할 수 없습니다. 원본 화면에서 다시 저장해주세요.");',
      "    },",
      "    close: function () {",
